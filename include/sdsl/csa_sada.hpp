...
public:
    ...
    //! Load from a memory-mapped region.
...
template <class t_enc_vec,
          ...
          uint32_t t_inv_dens,
          class t_sa_sample_strat,
          class t_isa_sample_strat,
          class t_alphabet_strat>
void csa_sada<t_enc_vec, t_dens, t_inv_dens, t_sa_sample_strat, t_isa_sample_strat, t_alphabet_strat>::load_mapped(
    char const *& addr)
{
